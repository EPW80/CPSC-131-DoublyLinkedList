...
namespace CPSC131::BookStore
{
	...
	{
		if (
			this->title_ == other.title_ && this->author_ == other.author_ && this->isbn_ == other.isbn_ && this->price_cents_ == other.price_cents_ && this->stock_available_ == other.stock_available_)
		{
			return true;
		}
		return false;
